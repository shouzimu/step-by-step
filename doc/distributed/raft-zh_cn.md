...
原文链接[百度大佬在github上开源的项目](https://github.com/maemual/raft-zh_cn)

[raft英文版pdf](https://modprobe.oss-cn-beijing.aliyuncs.com/github/distributed/raft-extended.pdf)
...
![图 1 ](https://modprobe.oss-cn-beijing.aliyuncs.com/github/distributed/raft/raft-图1.png)
...
![图 2 ](https://modprobe.oss-cn-beijing.aliyuncs.com/github/distributed/raft/raft-图2.png)
...
![图 3 ](https://modprobe.oss-cn-beijing.aliyuncs.com/github/distributed/raft/raft-图3.png)
...
![图 4 ](https://modprobe.oss-cn-beijing.aliyuncs.com/github/distributed/raft/raft-图4.png)

> 图 4：服务器状态。跟随者只响应来自其他服务器的请求。如果跟随者接收不到消息，那么他就会变成候选人并发起一次选举。获得集群中大多数选票的候选人将成为领导者。在一个任期内，领导人一直都会是领导人直到自己宕机了。

![图 5](https://modprobe.oss-cn-beijing.aliyuncs.com/github/distributed/raft/raft-图5.png)
...
![图 6](https://modprobe.oss-cn-beijing.aliyuncs.com/github/distributed/raft/raft-图6.png)
...
![图 7](https://modprobe.oss-cn-beijing.aliyuncs.com/github/distributed/raft/raft-图7.png)
...
![图 8](https://modprobe.oss-cn-beijing.aliyuncs.com/github/distributed/raft/raft-图8.png)
...
![图 9](https://modprobe.oss-cn-beijing.aliyuncs.com/github/distributed/raft/raft-图9.png)
...
![图 10](https://modprobe.oss-cn-beijing.aliyuncs.com/github/distributed/raft/raft-图10.png)
...
![图 11](https://modprobe.oss-cn-beijing.aliyuncs.com/github/distributed/raft/raft-图11.png)
...
![图 12](https://modprobe.oss-cn-beijing.aliyuncs.com/github/distributed/raft/raft-图12.png)
...
![图 13 ](https://modprobe.oss-cn-beijing.aliyuncs.com/github/distributed/raft/raft-图13.png)
...
![图 14](https://modprobe.oss-cn-beijing.aliyuncs.com/github/distributed/raft/raft-图14.png)
...
![图 15](https://modprobe.oss-cn-beijing.aliyuncs.com/github/distributed/raft/raft-图15.png)
...
![图 16](https://modprobe.oss-cn-beijing.aliyuncs.com/github/distributed/raft/raft-图16.png)
