package com.dh.antlr.sqlbuff.walkers;
...
import com.dh.antlr.sqlbuff.Tool;
import com.dh.antlr.sqlbuff.Trainer;
import com.dh.antlr.sqlbuff.kNNClassifier;
import com.dh.antlr.sqlbuff.misc.*;
...
//				                   " "+separator);
		...
		lens.add(com.dh.antlr.sqlbuff.Trainer.getSiblingsLength(siblings));

		// track the form split lists take for debugging
		if ( isSplitList ) {
			int form = com.dh.antlr.sqlbuff.Trainer.listform(ws);
